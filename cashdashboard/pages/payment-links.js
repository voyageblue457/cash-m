...
export default function PaymentLinksPage() {
  ...
  const { data: dynamicLinksRes, isLoading: linksLoading, refetch: refetchLinks } = useGetData(
    id ? `/dynamic-link/get/${id}` : null
  );
  const dynamicLinks = dynamicLinksRes?.data?.data || [];
  ...
  return (
    <div className="pb-16 text-gray-800 font-sans">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 items-start mb-8">
        ...
        {/* Form Container */}
        <div className="bg-white rounded-3xl p-6 shadow-xl border border-gray-150/60 xl:col-span-2">
        ...
        {/* Live Preview Column */}
        <div className="bg-white rounded-3xl p-6 shadow-xl border border-gray-150/60 xl:col-span-1 h-full flex flex-col justify-between">
          <div className="flex justify-between items-center border-b border-gray-100 pb-3 mb-4">
            <h3 className="text-sm font-black text-gray-700 font-mono tracking-tight uppercase">
              {selectedTheme} Live Preview
            </h3>
          ...
          <div className="bg-slate-100 rounded-3xl p-4 flex items-center justify-center flex-1 min-h-[380px]">
            <div className="w-[240px] h-[370px] bg-white rounded-[32px] shadow-2xl border-4 border-slate-800 relative overflow-hidden flex flex-col justify-between text-left select-none">
                ...
                <div className="h-full w-full bg-white text-gray-800 flex flex-col justify-between p-3 text-[8px]">
                  ...
                  <div className="bg-white border border-gray-100 shadow-sm rounded-xl p-2.5 mt-2 flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex justify-between items-center bg-gray-50 border border-gray-100 rounded-full p-0.5 scale-90">
                      ...
                      <div className="flex items-center gap-0.5 px-2 font-bold text-[6px] text-gray-400">
                        <span className="w-2.5 h-2.5 bg-gray-200 text-gray-500 rounded-full flex items-center justify-center text-[5px]">2</span> Pay
                      </div>
                    </div>
                    ...
                    <div className="flex gap-1 justify-center scale-95 mt-1">
                      {["$10", "$15", "$20", "$25"].map(v => (
                        <div key={v} className="px-1.5 py-0.5 border border-gray-250 bg-white text-gray-500 rounded-full text-[6px] font-bold">{v}</div>
                      ))}
                    </div>
                  </div>
              ...
              {selectedTheme === "CashApp Online" && (
                <div className="h-full w-full bg-[#f4f6f8] text-gray-800 flex flex-col justify-between p-3 text-[8px]">
                  {/* Mock Header */}
              ...
              {selectedTheme !== "Cash Green" && selectedTheme !== "Payin Cash" && selectedTheme !== "Pay Cash App" && (
                <div className={`h-full w-full flex flex-col justify-between p-3.5 text-[10px] ${
                  ...
                  selectedTheme === "CashApp Online" ? "bg-gradient-to-tr from-[#f3faf6] to-[#e8f5ed] text-gray-800" :
                  ...
                  <div className={`p-2.5 rounded-2xl flex-1 flex flex-col justify-between border ${
                    ...
                    <div className="space-y-1.5 flex-1 flex flex-col justify-end">
                      ...
                      <div className="text-center font-mono font-bold text-[9px] text-gray-400 mt-1">
      ...
      {/* Generated Link List */}
      <div className="bg-white rounded-3xl p-6 shadow-xl border border-gray-150/60">
